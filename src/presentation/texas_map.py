...
def build_location_map_frame(
    ...
    map_frame = (
        metrics.merge(battery_fields, on="location", how="left", validate="one_to_one")
        .merge(anchor_frame, on="location", how="left", validate="one_to_one")
        .sort_values(by="rank")
...
def build_texas_location_map(map_frame: pd.DataFrame, selected_location: str) -> go.Figure:
    ...
    figure.add_trace(
        go.Scattergeo(
            ...
            mode="markers+text",
            textfont={"family": "'SF Pro Text','Avenir Next','Segoe UI',sans-serif", "size": 11, "color": "#475457"},
            ...
            marker={
                ...
                "cmin": 0,
                "cmax": 100,
                "line": {"color": "rgba(255,255,255,0.72)", "width": 1.2},
                "colorbar": {"title": "Score"},
                "opacity": 0.94,
            },
            selected={"marker": {"line": {"color": "#7f4f3f", "width": 3.0}, "opacity": 1.0}},
    ...
    figure.update_layout(
        ...
        height=540,
        font={"family": "'SF Pro Text','Avenir Next','Segoe UI',sans-serif", "color": "#1f2628"},
    )
    return figure
